...
namespace AoC_Day1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string sequenceOfFrequencys;
            int[] ArrayOfFrequencys;

            Console.WriteLine("== Advent of Code: Day 1 ==");

            sequenceOfFrequencys = 
@"-16
+12
-6
-16
...
-113326";
            ...
            ArrayOfFrequencys = ToIntArr(sequenceOfFrequencys);

            totalFrequency = SumOfArr(ArrayOfFrequencys);
        ...
        static int SumOfArr(int[] frequencys)
        {
            int total = 0;
                
            total += frequencys.Sum();
